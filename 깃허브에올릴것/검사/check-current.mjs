...
const names=['chk','input52-static','t53-static','t54-avatar-static','t53-shop-static',
  ...
  't59-zombie-shape-static','t59-zombie-attachment-static','t60-zombie-wrap-static'];
let failed=0;
...
if(args.includes('--render')){await check('t54-view');await check('t56-build-view');await check('t57-character-view');await check('t59-zombie-view');}
