...
ALL=1204                       # 지금 전체 항목 수 (늘면 이 줄을 고친다) — 43차: t37 51→56(총열=조준선·총소리) · 42차: t37 47→51(점프·초읽기·출발 잠금·경주 속도) · 41차: t37 39→47(속도감 절) · 39차: t37 37→39(아이템 절 → 장애물 절) · 38차: 꽃밭·짝꿍·순위 갈래를 빼며 t23 84→29 · t19 12→6 · t20 58→55 · t26 46→45 · t27 47→46
